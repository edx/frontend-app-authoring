...
// Imports relocated from InVideoQuizEditor (adjusted relative paths)
import { navigateCallback } from '../../editors/hooks';
import analyticsEvt from '../../editors/data/constants/analyticsEvt';
...
import messages from '../../editors/containers/InVideoQuizEditor/messages';
import '../../editors/containers/InVideoQuizEditor/index.scss';
...
InVideoQuizEditorSlot.propTypes = {
...
export default InVideoQuizEditorSlot;
