...
export const RequestKeys = StrictDict({
  ...
  getAudioDescriptionUploadUrl: 'getAudioDescriptionUploadUrl',
  uploadAudioDescriptionToS3: 'uploadAudioDescriptionToS3',
  completeAudioDescriptionUpload: 'completeAudioDescriptionUpload',
