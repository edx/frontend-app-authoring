...
export const TimelineTileButton = ({
  ...
  return (
    <OverlayTrigger placement="top" overlay={tooltip}>
      <button
        type="button"
        aria-label={`${tile.typeLabel}: ${tile.displayName}, ${tile.subsectionTitle}, ${fmtMinutes(tile.minutes)}`}
        onClick={() => selectItem(tile.componentId)}
        className={`timeline-tile cor-tile--block-${tile.blockTypeModifier}`}
