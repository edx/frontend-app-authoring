...
const readFileText = (blob: Blob) => new Promise<string>((resolve, reject) => {
...
const flushPendingResponses = () => act(async () => {
...
describe('TranscriptEditor', () => {
  ...
  it('does not close while a save is in progress', async () => {
    ...
    axiosMock.onPost(/transcript_upload/).reply(() => new Promise<[number]>((resolve) => {
      finishSave = resolve;
    }));
    const onClose = jest.fn();
    renderEditor({ onClose });
